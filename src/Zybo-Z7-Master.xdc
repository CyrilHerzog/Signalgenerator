...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { dac_spi_cs }]   			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 }  [get_ports { dac_spi_sdo }]		     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { dac_ldac }]              
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { dac_spi_sclk }]              
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]                          
